...
//          $toadd['_no_notif'] = true;
   ...
   **/
   function showFormHelpdesk($ID, $ticket_template=false) {
      ...
      // Set default values... Desactiva la opcion de seleccionar observador al crear el ticket el decanato ***Vanessa Godoy 13/05/2016****
...
*/
	...
	// Desactiva opcion SEGUIMIENTO POR CORREO ***Vanessa Godoy 13/05/2016****
      /*if (empty($delegating)
      ...
      if (($_SESSION["glpiactiveprofile"]["helpdesk_hardware"] != 0)
		...
		// Desactiva opcion LOCALIDAD ***Vanessa Godoy 13/05/2016****
      /*if (!$tt->isHiddenField('locations_id')) {
	...
	// Desactiva opcion OBSERVACORES ***Vanessa Godoy 13/05/2016****
